...
const VERSION_HISTORY: Array<{ version: string; date: string; note: string }> = [
  ...
  },
  {
    ...
    note:
      ...
      'enacted budget raises the starting base salary and grants an average increase of 8%, part ' +
      'of it funded as a one-time bonus; the Governor funds an 11% average raise entirely as ' +
